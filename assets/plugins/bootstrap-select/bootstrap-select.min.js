        ...
        k.VERSION = "1.12.2", k.DEFAULTS = {
            ...
            liHeight: function(b) {
                if (b || this.options.size !== !1 && !this.sizeInfo) {
                    ...
                    if (i.className = "text", c.className = this.$menu[0].parentNode.className + " show", d.className = "dropdown-menu show", e.className = "dropdown-menu inner", f.className = "divider", i.appendChild(document.createTextNode("Inner text")), h.appendChild(i), g.appendChild(h), e.appendChild(g), e.appendChild(f), j && d.appendChild(j), k) {
